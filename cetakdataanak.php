...
// Atur limit regex (jika data banyak)
ini_set("pcre.backtrack_limit", "10000000");

// Ambil data anak dari tabel `anak`
$anak = mysqli_query($conn, "SELECT * FROM anak");
...
<h3>Data Pendaftar Anak Posyandu</h3>
<table>
    <thead>
        <tr>
            <th>No</th>
...
$i = 1;
while ($row = mysqli_fetch_assoc($anak)) {
    $html .= '
    <tr>
        <td>' . $i++ . '</td>
...
// Cetak ke PDF
$mpdf->WriteHTML($html);
$mpdf->Output('data-anak.pdf', \Mpdf\Output\Destination::INLINE);
